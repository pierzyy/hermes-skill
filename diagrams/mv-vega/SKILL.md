...
metadata:
  ...
  hermes:
    tags: ["charts", "Vega-Lite", "data-viz", "statistics"]
    related_skills: ["mv-infographic", "mv-data-analytics"]
---

> **Hermes Usage:** Load with `skill_view(name="mv-vega")`. Output charts as Vega-Lite/Vega JSON in Markdown code blocks.
